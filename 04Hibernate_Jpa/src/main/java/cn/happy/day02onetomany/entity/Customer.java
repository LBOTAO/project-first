package cn.happy.day02onetomany.entity;
 ...
 */
@Entity//表明该类是一个实体类
@Table(name="customer")//建立当前类和数据库表的对应关系
public class Customer implements Serializable {
	...
	/**
	 * targetEntity = LinkMan.class, 目标实体
	 * cascade = CascadeType.ALL  级联所有持久化方法
	 * fetch = FetchType.EAGER  标识为立即加载
	 */
	@OneToMany(targetEntity = LinkMan.class,mappedBy = "customer",cascade = CascadeType.ALL,fetch = FetchType.EAGER)
	private Set<LinkMan> linkMen=new HashSet<LinkMan>(0);
